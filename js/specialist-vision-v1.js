'use strict';
(function(root){
  let handDetector=null, handLoading=null, segmenter=null, segmenterLoading=null;
  const SEGMENT_MAP={
  ...
  root.MiraSpecialistVisionV1={ensureHands,ensureSegmenter,analyzeHands,segment,labelAt,regionBox,classifyRegion,handEntities,SEGMENT_MAP};
