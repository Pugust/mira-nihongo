...
(function(root){
  ...
  function snapshot(){return{hands:{loaded:!!handDetector,loading:!!handLoading},pose:{loaded:!!poseDetector,loading:!!poseLoading},face:{loaded:!!faceDetector,loading:!!faceLoading},segmentation:{loaded:!!segmenter,loading:!!segmenterLoading}}}
  root.MiraSpecialistVisionV1={ensureHands,ensurePose,ensureFace,ensureSegmenter,analyzeHands,analyzePose,analyzeFaces,segment,labelAt,regionBox,classifyRegion,handEntities,poseEntities,faceEntities,SEGMENT_MAP,snapshot};
