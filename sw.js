'use strict';
const CACHE='mira-nihongo-v0-9-1-r1';
const LOCAL=['./','./index.html','./css/app.css','./js/recognition-policy.js','./js/world-context.js','./js/vision-engine.js','./js/japanese-data.js','./js/learning-engine.js','./js/adaptive-learning.js','./js/interaction-engine.js','./js/app.js','./js/reliability-engine.js','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
