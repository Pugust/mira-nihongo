'use strict';
const CACHE='mira-nihongo-v0-5-r1';
const LOCAL=['./','./index.html','./css/app.css','./js/recognition-policy.js','./js/vision-engine.js','./js/japanese-data.js','./js/learning-engine.js','./js/app.js','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png'];
