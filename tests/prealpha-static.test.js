...
for(const token of ['world-model-v1.js','recognition-fusion-v1.js','visual-ontology-v1.js','mira-nihongo-v1-prealpha1-rc2-r1'])assert(sw.includes(token),token);
...
const css=fs.readFileSync('css/app.css','utf8');assert(css.includes('.camera-stage.frozen .boxes-layer{pointer-events:none}'));console.log('rc2-overlap-and-unknown guards ok');
