...
for(const token of ['exploreSceneBtn','sceneBreadcrumb','world-model-v1.js','world-model-v2.js','recognition-fusion-v1.js','visual-ontology-v1.js'])assert(html.includes(token),token);
for(const token of ['world-model-v1.js','world-model-v2.js','recognition-fusion-v1.js','visual-ontology-v1.js','mira-nihongo-v1-prealpha2-1-r1'])assert(sw.includes(token),token);
