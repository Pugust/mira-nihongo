...
for(const token of ['world-model-v1.js','world-model-v2.js','recognition-fusion-v1.js','visual-ontology-v1.js','mira-nihongo-v1-prealpha3-r2'])assert(sw.includes(token),token);
